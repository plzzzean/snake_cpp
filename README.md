...
- `src/Food.*`: Growth Item의 생성 개수와 10초 재생성 정책을 관리합니다.
...
- `src/Poison.*`: Poison Item의 생성 개수와 10초 재생성 정책을 관리합니다.
...
- Growth Item과 Poison Item은 10초마다 기존 위치에서 사라지고 새 빈 칸에 재생성됩니다.
...
7. 10초가 지난 Growth Item과 Poison Item은 새 빈 위치에 재생성됩니다.
